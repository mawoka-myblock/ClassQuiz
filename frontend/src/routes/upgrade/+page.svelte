...
<div>
	<div class="mb-12">
		...
		<div class="w-1/3 mx-auto">
			...
			<h2 class="text-center text-4xl m-2">What will ClassQuiz Free be?</h2>
			<p class="text-center">
	...
	<div class="grid grid-cols-2 w-1/2 mx-auto gap-8">
		<div
			class="rounded-lg bg-white dark:bg-gray-700 p-3 shadow-2xl ring-green-600 dark:shadow-gray-700 shadow-white opacity-80"
		...
		<div
			class="rounded-lg bg-white dark:bg-gray-700 p-3 shadow-2xl ring-green-600 shadow-green-600"
			class:ring-4={$premium}
		>
			<h3 class="text-4xl text-center">
				<span class="marck-script text-5xl">ClassQuiz</span>
			...
			<div class="flex flex-row gap-2 m-2">
				{#if $premium}
					<BrownButton href="/api/v1/users/billing/portal-session?return_url=/upgrade"
						>Manage Subscription</BrownButton
					>
				{:else}
					<BrownButton
						disabled={loading}
